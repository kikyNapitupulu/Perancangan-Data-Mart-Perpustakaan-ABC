          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT *, students.student_id AS stud FROM borrow LEFT JOIN students ON students.student_id=borrow.student_id LEFT JOIN books ON books.book_id=borrow.book_id ORDER BY date_borrow DESC";
